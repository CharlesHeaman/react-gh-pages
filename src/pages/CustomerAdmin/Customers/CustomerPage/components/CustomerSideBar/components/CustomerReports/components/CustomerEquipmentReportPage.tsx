...
const CustomerEquipmentReportPage = () => {
    ...
    return (
        <OuterContainer 
            ...
            maxWidth={1200}
        >
            {equipmentData && serviceTicketsData && invoiceRequestData && siteListNotesData && plannedMTicketsData && quoteData && quotedEquipmentData && equipmentData.data.map((equipment, index) => 
                <div key={index}>
                    <InfoGrid>
                        <GridItem>
...
export default CustomerEquipmentReportPage