...
import { Coordinates, CreateSiteAttributes } from "../../../../../types/sites.types";
...
const SiteLocationForm = (props: {
    ...
    const [coordinates, setCoordinates] = useState<Coordinates | undefined>(props.siteDetails.coordinates);

    const getCoordinates = () => {
        getMapLatLng(`${props.siteDetails.address}, ${props.siteDetails.postcode}`, (coordinates) => {
            ...
            <InfoGrid>                
                <GridItem title='Address' span={4}>
                    <TextareaInput
                        ...
                        name="address"
                        label="Address"
                        value={props.siteDetails.address}
                ...
                <GridItem title='Postcode' span={2}>
                    <PostcodeInput
                        name="postcode"
                        value={props.siteDetails.postcode}
                        updateFunc={props.updateParams}
                        hasSubmitted={props.showErrors}                        
                        required
                    />
                ...
                <GridItem span={2}>
                    <FormErrorMessage 
                        ...
                        show={props.showErrors && props.siteDetails.coordinates.lat === 0}
                    />
                    <ActionButton 
