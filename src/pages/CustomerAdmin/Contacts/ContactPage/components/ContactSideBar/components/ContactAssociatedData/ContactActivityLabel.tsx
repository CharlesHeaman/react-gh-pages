...
const ContactActivityLabel = (props: {
    action: number
}) => {
    const getLabel = () => {
        switch (props.action) {
            ...
            case 5:
                return <Label text="Site Assigned " iconFont="add" color="no-color"/>
            case 6:
                return <Label text="Site Unassigned" iconFont="remove" color="no-color"/>
            default:
...
export default ContactActivityLabel