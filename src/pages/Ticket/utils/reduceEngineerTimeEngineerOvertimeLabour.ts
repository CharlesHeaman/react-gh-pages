...
const reduceEngineerTimeEngineerOvertimeLabour = (engineerTime: Array<InvoiceTicketTimeResponseData>) => {
...
export default reduceEngineerTimeEngineerOvertimeLabour