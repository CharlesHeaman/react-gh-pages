...
const CreateTicketInterimInvoice = (props: {
    ...
    return (
        ...
        >
            <InfoGrid>
                <GridItem>
                    <p>Complete invoice details and write a note to create an interim invoice for this ticket.</p>
                </GridItem>
...
export default CreateTicketInterimInvoice