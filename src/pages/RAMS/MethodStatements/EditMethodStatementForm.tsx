...
const EditMethodStatementTemplateForm = (props: {
    template: MethodStatementTemplateResponseData,
    ...
    const updateMethodStatementTemplate = () => {
        ...
        putAPI(`risk_assessment_templates/${props.template.id}/update`, {}, {
            ...
            props.setMethodStatementTemplateData(templateData);
            props.disabledEdit();
        }, setIsUpdating);
    }
...
export default EditMethodStatementTemplateForm