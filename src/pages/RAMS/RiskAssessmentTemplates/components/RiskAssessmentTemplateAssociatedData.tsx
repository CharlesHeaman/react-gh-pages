...
const RiskAssessmentTemplateAssociatedData = (props: {
    ...
    const updateRiskAssessmentTemplateTemplate = () => {
    ...
    return (
        <>
            <PermsProtectedComponent requiredPerms={{ templates: props.templateContent.length > 0 ? 1 : 2 }}>                
            ...
            <WindowOverlay 
                ...
                footer={<SubmitButton
                    ...
                    clickFunc={updateRiskAssessmentTemplateTemplate}
                />
            }
            >
                <InfoGrid>
...
export default RiskAssessmentTemplateAssociatedData